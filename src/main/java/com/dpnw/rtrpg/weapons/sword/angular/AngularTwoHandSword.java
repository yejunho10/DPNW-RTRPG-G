...
public class AngularTwoHandSword extends Sword {

    public AngularTwoHandSword(Material type) {
        setType(type);
        setWeaponName(WeaponName.ANGULAR_TWO_HAND_SWORD);
        setDisplayName("반듯한 양손검");
