...
public enum WeaponName {
    ...
    APPRENTICE_BOOTS("APPRENTICE_BOOTS", "견습 장화", WeaponType.BOOTS),
    APPRENTICE_BOW("APPRENTICE_BOW", "견습 활", WeaponType.BOW),
    APPRENTICE_BUCKLER("APPRENTICE_BUCKLER", "견습 버클러", WeaponType.BUCKLER),
    ...
    APPRENTICE_HELMET("APPRENTICE_HELMET", "견습 투구", WeaponType.HELMET),
    APPRENTICE_KNIFE("APPRENTICE_KNIFE", "견습 단도", WeaponType.KNIFE),
    APPRENTICE_LEGGINGS("APPRENTICE_LEGGINGS", "견습 각반", WeaponType.LEGGINGS),
    APPRENTICE_MACE("APPRENTICE_MACE", "견습 메이스", WeaponType.MACE),
    APPRENTICE_MAIL("APPRENTICE_MAIL", "견습 갑옷", WeaponType.MAIL),
    APPRENTICE_ONE_HAND_SWORD("APPRENTICE_ONE_HAND_SWORD", "견습 한손검", WeaponType.ONEHANDSWORD),
    APPRENTICE_SHIELD("APPRENTICE_SHIELD", "견습 방패", WeaponType.SHIELD),
    ...
    EXPERT_LEGGINGS("EXPERT_LEGGINGS", "숙련자 각반", WeaponType.LEGGINGS),
    EXPERT_MACE("EXPERT_MACE", "숙련자의 메이스", WeaponType.MACE),
    EXPERT_MAIL("EXPERT_MAIL", "숙련자 갑옷", WeaponType.MAIL),
    EXPERT_ONE_HAND_SWORD("EXPERT_ONE_HAND_SWORD", "숙련자의 한손검", WeaponType.ONEHANDSWORD),
    EXPERT_SHIELD("EXPERT_SHIELD", "숙련자의 방패", WeaponType.SHIELD),
