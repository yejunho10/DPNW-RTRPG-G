...
public enum WeaponName {
    ...
    //한손검
    ANGULAR_ONE_HAND_SWORD("ANGULAR_ONE_HAND_SWORD", "반듯한 한손검", WeaponType.ONE_HAND_SWORD),
    APPRENTICE_ONE_HAND_SWORD("APPRENTICE_ONE_HAND_SWORD", "견습 한손검", WeaponType.ONE_HAND_SWORD),
    EXPERT_ONE_HAND_SWORD("EXPERT_ONE_HAND_SWORD", "숙련자의 한손검", WeaponType.ONE_HAND_SWORD),
    RUSTY_ONE_HAND_SWORD("RUSTY_ONE_HAND_SWORD", "녹슨 한손검", WeaponType.ONE_HAND_SWORD),
    SLIME_ONE_HAND_SWORD("SLIME_ONE_HAND_SWORD", "점액질 한손검", WeaponType.ONE_HAND_SWORD),
    QUEENS_ONE_HAND_SWORD("QUEENS_ONE_HAND_SWORD", "여왕의 한손검", WeaponType.ONE_HAND_SWORD),
    ORCS_TUSK_ONE_HAND_SWORD("ORCS_TUSK_ONE_HAND_SWORD", "오크엄니 한손검", WeaponType.ONE_HAND_SWORD),

    //양손검
    ANGULAR_TWO_HAND_SWORD("ANGULAR_TWO_HAND_SWORD", "반듯한 양손검", WeaponType.TWO_HAND_SWORD),
    APPRENTICE_TWO_HAND_SWORD("APPRENTICE_TWO_HAND_SWORD", "견습 양손검", WeaponType.TWO_HAND_SWORD),
    EXPERT_TWO_HAND_SWORD("EXPERT_TWO_HAND_SWORD", "숙련자의 양손검", WeaponType.TWO_HAND_SWORD),
    OGRE_TWO_HAND_SWORD("OGRE_TWO_HAND_SWORD", "오우거 대검", WeaponType.TWO_HAND_SWORD),
    RUSTY_TWO_HAND_SWORD("RUSTY_TWO_HAND_SWORD", "녹슨 양손검", WeaponType.TWO_HAND_SWORD),
    SLIME_TWO_HAND_SWORD("SLIME_TWO_HAND_SWORD", "점액질 양손검", WeaponType.TWO_HAND_SWORD),
    ORCS_TUSK_TWO_HAND_SWORD("ORCS_TUSK_TWO_HAND_SWORD", "오크엄니 양손검", WeaponType.TWO_HAND_SWORD),

    //쌍검
    ANGULAR_DUAL_SWORD("ANGULAR_DUAL_SWORD", "반듯한 쌍검", WeaponType.DUAL_SWORD),
    APPRENTICE_DUAL_SWORD("APPRENTICE_DUAL_SWORD", "견습 쌍검", WeaponType.DUAL_SWORD),
    EXPERT_DUAL_SWORD("EXPERT_DUAL_SWORD", "숙련자의 쌍검", WeaponType.DUAL_SWORD),
    RUSTY_DUAL_SWORD("RUSTY_DUAL_SWORD", "녹슨 쌍검", WeaponType.DUAL_SWORD),
    SLIME_DUAL_SWORD("SLIME_DUAL_SWORD", "점액질 쌍검", WeaponType.DUAL_SWORD),
    QUEENS_DUAL_SWORD("QUEENS_DUAL_SWORD", "여왕의 쌍검", WeaponType.DUAL_SWORD),
    ORCS_TUSK_DUAL_SWORD("ORCS_TUSK_DUAL_SWORD", "오크엄니 쌍검", WeaponType.DUAL_SWORD),
